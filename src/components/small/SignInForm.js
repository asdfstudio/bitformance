...
export default function SignInForm({ setShowModalType, forgotPassword, setForgotPassword }) {
	...
	const SignIn = () => (<>
		...
		<div className="flex flex-row gap-2">
			...
			<button onClick={() => setForgotPassword(true)} className="ml-auto underline text-blue-500">Forgot Password?</button>
		</div>
	...
	return forgotPassword ? <ForgotPassword /> : <SignIn />
}