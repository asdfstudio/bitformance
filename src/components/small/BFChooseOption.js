...
export default function BFChooseOption({ isMarketCapWeightAvailable, onSelect, selected, options }) {
	...
	const notSelectedStyle = 'w-full h-[38px] rounded-lg bg-main-lightGray text-main-gray px-3 cursor flex flex-row items-center text-[15px] font-DM_Sans font-medium leading-normal tracking-normal whitespace-nowrap md:w-[106px]'
